...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MapView = __webpack_require__(192);
	
	var _MapView2 = _interopRequireDefault(_MapView);
	
	var _MarkersView = __webpack_require__(197);
	
	var _MarkersView2 = _interopRequireDefault(_MarkersView);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var kmap = new _MapView2.default('maps').initMap({ zoom: 5 });
	var markerList = new _MarkersView2.default(kmap).regenerateList();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(15);
	$def($def.S, 'Object', {is: __webpack_require__(46)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.S, 'Math', {expm1: __webpack_require__(86)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.S, 'Math', {log1p: __webpack_require__(78)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.S, 'Math', {sign: __webpack_require__(82)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(17)(IteratorPrototype, __webpack_require__(31)('iterator'), function(){ return this; });
	...
	var MapView = (function () {
	  ...
	  _createClass(MapView, [{
	    ...
	    value: function initMap() {
	      ...
	      var lat = _ref$lat === undefined ? 13 : _ref$lat;
	      var _ref$lng = _ref.lng;
	      var lng = _ref$lng === undefined ? 122 : _ref$lng;
	      var _ref$zoom = _ref.zoom;
	      var zoom = _ref$zoom === undefined ? 6 : _ref$zoom;
	    ...
	    value: function addListener() {
	      ...
	      this.map.addListener('click', function (ev) {
	        _this.markerList.push(new _Marker2.default(_this.map, ev.latLng));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LabelGenerator = __webpack_require__(194);
	
	var _LabelGenerator2 = _interopRequireDefault(_LabelGenerator);
	...
	var Marker = (function () {
	  function Marker(map, latLng) {
	    ...
	    var description = arguments.length <= 2 || arguments[2] === undefined ? _LabelGenerator2.default.next().value : arguments[2];
	    ...
	    this.infoWindow = new _InfoWindow2.default(description).info;
	    this.addListener();
	    this.map = map;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LabelGenerator = (function () {
	  function LabelGenerator() {
	    _classCallCheck(this, LabelGenerator);
	
	    this.labels = ['@_@', '>_<', '^_^', '~_~', '>_>', '$_$'];
	  }
	
	  _createClass(LabelGenerator, [{
	    key: Symbol.iterator,
	      ...
	      return regeneratorRuntime.wrap(function value$(_context) {
	        while (1) switch (_context.prev = _context.next) {
	          ...
	          case 1:
	            ...
	            _context.next = 4;
	            return this.labels[current % this.labels.length];
	...
	exports.default = labelGenerator[Symbol.iterator]();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ColorGenerator = __webpack_require__(196);
	...
	var InfoWindow = function InfoWindow(content) {
	  _classCallCheck(this, InfoWindow);
	
	  this.info = new google.maps.InfoWindow({
	    content: '<div><h3 style="color:' + _ColorGenerator2.default.getRandomColor() + '">' + content + '</h3></div>'
	  });
	};
	...
	var ColorGenerator = (function () {
	  ...
	  _createClass(ColorGenerator, [{
	    ...
	    value: function getRandomHex() {
	      var num = _.random(0, 255).toString(16);
...
/***/ function(module, exports) {
	...
	var MarkersView = (function () {
	  function MarkersView(mapView) {
	    _classCallCheck(this, MarkersView);
	
	    this.mapView = mapView;
	    mapView.subscribe(this);
	  }
	
	  _createClass(MarkersView, [{
	    key: 'createListItemAngularMaterial',
	    value: function createListItemAngularMaterial() {
	      var $list = document.createElement('md-list-item');
	    ...
	    key: 'createListItemBootstrap',
	    value: function createListItemBootstrap() {
	    ...
	    key: 'createListItemMdl',
	    value: function createListItemMdl(marker) {
	    ...
	    key: 'regenerateList',
	    value: function regenerateList() {
	      var markerList = document.querySelector('[hook="markerListView"]');
	      ...
	      try {
	        for (var _iterator = this.mapView.markerList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
